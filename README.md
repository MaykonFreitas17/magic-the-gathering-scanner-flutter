...
- [x] Implementar Seletor de Idioma (EN / PT-BR) com tradução via IA.
- [x] Renderização de Símbolos de Mana dinâmicos dentro dos textos explicativos.
...
- [ ] Implementar o fluxo de Criação de novo Deck.
- [ ] Desenvolver a Tela de Detalhes do Deck.
